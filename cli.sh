...
#	Description: 985 Manager CLI
#	Version: 1.0.0
#	Author: 985 Manager Team
#=================================================

cli_ver="1.0.0"
github="raw.githubusercontent.com/pig0224/985-manager/main"
...
Install_Manager(){
	echo "===================================================="  
	echo "========= Start installing the 985 Manager ========="
	echo "===================================================="
	...
	if [ $? -eq 0 ]; then
		ln -sf /opt/node-v20.11.1-linux-x64/bin/985 /usr/local/bin/
...
Uninstall_Manager(){
	echo "=================================================="
	echo "========= Start uninstalling 985 Manager ========="
	echo "=================================================="
...
start_menu(){
clear
echo && echo -e "985 Manager CLI ${Red_font_prefix}[v${cli_ver}]${Font_color_suffix}
...
————————————————————————————————" && echo
	...
	# 	echo -e " Status: ${Green_font_prefix}Not installed${Font_color_suffix} 985 Manager ${Red_font_prefix} Please install. ${Font_color_suffix}"
	# else
